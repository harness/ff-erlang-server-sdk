...
boolean_flag_off() ->
  #{
    ...
    [
      #{
        targets => [#{identifier => <<"target_identifier">>, name => <<"target_test">>}],
        variation => <<"true">>
      }
    ],
    variations
...
string_flag_off() ->
  #{
    ...
    [
      #{
        targets => [#{identifier => <<"target_test_1">>, name => <<"target_test_1">>}],
        variation => <<"Serve_it">>
      }
    ],
    variations
    =>
    [
      #{identifier => <<"Serve_it">>, name => <<"Serve it">>, value => <<"serve it">>},
      #{
...
number_flag_off() ->
  #{
    ...
    environment => <<"dev">>,
    feature => <<"My_cool_number_flag">>,
    kind => <<"int">>,
    offVariation => <<"Serve_a_zero_int">>,
    prerequisites => [],
    project => <<"erlangsdktest">>,
    rules
    =>
    ...
    [
      #{
        ...
        =>
        [
          #{identifier => <<"target_identifier_3434">>, name => <<"target_test">>},
          #{identifier => <<"target_test_1">>, name => <<"target_test_3">>}
        ],
    ...
    =>
    [
      #{identifier => <<"Serve_an_int">>, name => <<"Serve an int">>, value => <<"12456">>},
      #{identifier => <<"Serve_a_zero_int">>, name => <<"Serve a zero int">>, value => <<"0">>},
      #{identifier => <<"Serve_a_float">>, name => <<"Serve a float">>, value => <<"1.55">>},
      #{
        identifier => <<"Serve_a_zero_float">>,
        name => <<"Serve a zero float">>,
        value => <<"0.001">>
      }
    ],
    version => 3
  ...
  #{
    ...
    [
      #{
        ...
        [
          #{identifier => <<"target_identifier_3434">>, name => <<"target_test">>},
          #{identifier => <<"target_identifier_1">>, name => <<"target_test_3">>}
        ],
    ...
    [
      #{
        ...
        [
          ...
          #{identifier => <<"target_test_2">>, name => <<"target_test_2">>}
        ],
        variation => <<"Dont_serve_it">>
      }
    ],
  ...
  #{
    ...
    [
      #{
        ...
        =>
        [
          #{identifier => <<"target_identifier_1">>, name => <<"target_test">>},
          #{identifier => <<"target_test_2">>, name => <<"target_test_2">>}
        ],
        variation => <<"Dont_serve_it">>
      }
      ...
      [
        #{
          ...
          [
            #{
              attribute => <<>>,
              id => <<"ab366b87-e194-44f3-8790-97c2058193db">>,
              negate => false,
              op => <<"segmentMatch">>,
              values => [<<"group1">>]
            }
          ...
          priority => 0,
          ruleId => <<"12410622-e1d1-46c9-acb3-e177c9dd4575">>,
          serve
          =>
          #{
            distribution
        ...
        #{
          ...
          [
            #{
              attribute => <<>>,
              id => <<"c693c5ef-69eb-4309-91b2-9c0c10d69cae">>,
              negate => false,
              op => <<"segmentMatch">>,
              values => [<<"group2">>]
            }
          ...
          priority => 2,
          ruleId => <<"c70ac397-081e-4774-adef-570573b5c350">>,
          serve
          =>
          #{
            distribution
            ...
            #{
              ...
              variations
              =>
              [#{variation => <<"true">>, weight => 1}, #{variation => <<"false">>, weight => 99}]
            }
          }
        }
      ],
...
prerequisite_matches_flag_1() ->
  #{
    defaultServe => #{variation => <<"Surfing is boring">>},
    environment => <<"dev">>,
    feature => <<"myprereqflag">>,
    kind => <<"boolean">>,
    offVariation => <<"false">>,
    ...
    =>
    [
      #{identifier => <<"Surfing is boring">>, name => <<"Surfing boring">>, value => <<"boring!">>},
      #{identifier => <<"Surfing is fun">>, name => <<"Surfing fun">>, value => <<"fun!">>}
    ],
    version => 2
  }.
...
prerequisite_matches_flag_2() ->
  #{
    defaultServe => #{variation => <<"Football is boring">>},
    environment => <<"dev">>,
    feature => <<"myprereqflag2">>,
    kind => <<"boolean">>,
    offVariation => <<"false">>,
    ...
    =>
    [
      #{identifier => <<"Football is cool">>, name => <<"Football cool">>, value => <<"cool!!">>},
      #{
        identifier => <<"Football is boring">>,
